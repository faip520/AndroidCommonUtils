...
public class FreeMovableImageView extends ImageView {
	...
	// 旋转系数累积量
	private float mRotateAccumulation = 0.0f;
	...
	public void setFMClickListener(OnClickListener listener) {
...
//			mAnchorDrawable.draw(canvas);
	...
	protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
		...
		mInitialRect.set(left, top, right, bottom);
	}
