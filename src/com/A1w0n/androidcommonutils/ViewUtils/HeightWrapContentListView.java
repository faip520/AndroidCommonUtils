 ...
 */
public class HeightWrapContentListView extends ListView {

    private int mHeightMaxItem = 4;

    public HeightWrapContentListView(Context context) {
        super(context);
    }

    public HeightWrapContentListView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public HeightWrapContentListView(Context context, AttributeSet attrs, int defStyleAttr) {
